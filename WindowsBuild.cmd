...
ECHO [93mCompiling CoreEngine Resource Compilers Library...[0m
dotnet.exe build /nologo -c Debug -v Q -o "." "..\..\src\CoreEngine.ResourceCompilers"

@IF %ERRORLEVEL% == 0 (
   GOTO CompileCoreEngineCompiler
)
@IF NOT %ERRORLEVEL% == 0 (
   GOTO CompileError
)

:CompileCoreEngineCompiler
